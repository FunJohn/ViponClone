<form action="/" class="search">
    <div class="input-group">
        <div class="input-group-append">
                                <span class="input-group-text input-icon-top-append"><em
                                            class="fa fa-search fa-lg"></em></span>
        </div>
        <input type="text" class="form-control input-s-top search-form-header"
               placeholder="Search Stores, Coupons, or Deal">
        <div class="input-group-append">
            <span class="input-group-text input-s-top-append">SEARCH</span>
        </div>
    </div>
	{{--    <p class="popular-search hidden-sm hidden-xs">
        Popular Searches: black friday nike home depot ivory vistaprint
    </p> --}}
</form>
